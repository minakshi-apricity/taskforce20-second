...
export default function ToiletRegisterScreen({ navigation, embedded = false }: { navigation: Nav, embedded?: boolean }) {
...
const styles = StyleSheet.create({
    ...
    // Header Removed for embedded, handled by Layout for standalone
    header: {
